...
class HomeCommentWidget extends StatefulWidget {
  ...
  @override
  State<HomeCommentWidget> createState() => _CommentWidgetState();
}

class _CommentWidgetState extends State<HomeCommentWidget> {
                  ...
                  children: [
                    InkWell(
                      onTap: () {
                        ...
                        _controller.videoController(widget.index!)!.pause();
                        if (dataStorage.read('isLogging') == true) {
                          Get.to(
                            ...
                            _controller.videoController(widget.index!)!.play();
                          });
                        } else {
